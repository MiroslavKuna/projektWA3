...
<html lang="en">
  ...
  <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 border-top fixed-bottom">
    ...
    <ul class="nav col-md-4 justify-content-end list-unstyled d-flex mx-5">
      <li class="ms-3"><a class="" href="#"> <img src="/img/discord.png" class="img-fluid" alt="" height="24" width="24"> </a></li>
      <li class="ms-3"><a class="" href=""> <img src="/img/reddit.png" class="img-fluid" alt="" height="30" width="30"> </a></li>
      <li class="ms-3"><a class="" href=""> <img src="/img/twitter.png" class="img-fluid" alt="" height="24" width="24"> </a></li>
    </ul>
  </footer>
