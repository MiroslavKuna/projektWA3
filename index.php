...
<body>
    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0 mx-5">
          ...
          <li><a href="/sites/about.php" class="nav-link px-2 text-white">API</a></li>
        </ul>
  ...
  <div class="container my-5">
    ...
    <p>
      Factorio is the father of all factory building games. Share your tips and tricks and connect with other engineers
      from around the world! <br> We discuss all things Factorio here.
    </p>
    <div class="row mt-5">
      <div class="col-md-6">
      ...
      <div class="col-md-6">
        ...
        <ul class="list-group">
          ...
          <li class="list-group-item list-group-item-warning">Simple ratios</li>
        </ul>
      </div>
    </div>
  </div>
